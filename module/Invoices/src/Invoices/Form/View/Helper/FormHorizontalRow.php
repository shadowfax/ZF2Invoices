<?php
namespace Invoices\Form\View\Helper;
...
class FormHorizontalRow extends AbstractHelper
{
    ...
    public function render(ElementInterface $element)
    {
            ...
            if ($type === 'multi_checkbox' || $type === 'radio') {
                ...
                switch ($this->labelPosition) {
                    case self::LABEL_PREPEND:
                        ...
                        $markup .= sprintf('<div class="controls">%s</div>', $elementString);
                        break;
        ...
        if ($element->hasAttribute('required')) {
              	$control_group_classes .= " required";
        }
        $markup = sprintf('<div class="%s">%s</div>', $control_group_classes, $markup);
